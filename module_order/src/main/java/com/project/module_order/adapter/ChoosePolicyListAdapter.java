 ...
 * @description: 首页订单列表
 */
public class ChoosePolicyListAdapter extends BaseBindableAdapter<OrderItemPolicyChooseBinding, InsureListResDTO.ResultListBean> {
    @Override
    ...
    @Override
    public void onBindHolder(BaseViewHolder holder, OrderItemPolicyChooseBinding binding, @Nullable InsureListResDTO.ResultListBean orderModel, int index) {
        if (orderModel == null) {
            return;
        }
