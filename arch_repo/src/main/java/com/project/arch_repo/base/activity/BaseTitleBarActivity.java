...
import com.project.arch_repo.databinding.ArchBindLayoutTitleBinding;
import com.project.arch_repo.widget.titlebar.TokenTitleBar;
...
public class BaseTitleBarActivity extends BaseActivity {
    ...
    @NonNull
    public final TokenTitleBar getTitleBar() {
        return titleBar;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleBinding.ivLeftIcon.setOnClickListener(new View.OnClickListener() {
            @Override
