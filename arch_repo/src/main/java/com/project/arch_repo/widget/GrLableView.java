...
/**
 * @Project: token-card-android-pro
 * @Description:
 * @Author: haijianming
 * @Time: 2019/2/17 下午8:02
 */
public class GrLableView extends ViewGroup implements View.OnClickListener {
    ...
    public GrLableView(Context context) {
        super(context);
        mContext = context;
        showEditPreview();
    }

    public GrLableView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public GrLableView(Context context, AttributeSet attrs, int defStyleAttr) {
