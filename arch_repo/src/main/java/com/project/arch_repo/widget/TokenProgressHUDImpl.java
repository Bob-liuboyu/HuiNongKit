 ...
 */
public class TokenProgressHUDImpl implements ProgressHUD {
    ...
    public TokenProgressHUDImpl() {
    }

    public TokenProgressHUDImpl(@NonNull Context context) {
    ...
    public static AlphaLoading createProgressHUD(Context actionContext) {
        return new AlphaLoading.Builder(actionContext)
                ...
                .okIcon(R.mipmap.loading_success)
                .failIcon(R.mipmap.loading_fail)
                .create();
    }
